    ...
    var body: some View {
        VStack{
            ...
            ZStack(alignment: .top){
                ...
                HStack(){
                    Spacer()
                    PieChartView(values: player.sound.chartParts(), colors: [ColorType.White.getColor(), ColorType.Yellow.getColor(), ColorType.Red.getColor()], colorsText: [ColorType.White.getTextColor(), ColorType.Yellow.getTextColor(), ColorType.Red.getTextColor()], backgroundColor: Color.clear).frame(width: 112, height: 112)

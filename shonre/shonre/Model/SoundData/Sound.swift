...
class Sound : Identifiable, ObservableObject {
    ...
    init(id : UUID, waves : [SingleWave], length : Double, timeInBed : Double, started : Date, stoped : Date, fileName : String){
        self.id = id
        self.waves = waves
        self.length = length
        ...
        self.timeNoSnoringPercentWhite = 0
        self.timeSnoringPercentRed = 0
        self.timeSnoringPercentYellow = 0
    }
    
    
    init(id : UUID, samples : [Float], length : Double, timeInBed : Double, started : Date, stoped : Date, fileName : String){
        self.id = id
    ...
    func addSamples(samples : [Float]){
        ...
        self.waves.append(contentsOf: addWawes)
    }
...
extension Sound {
    ...
    static var data = [Sound(id: UUID(), samples: floats, length: 1.0, timeInBed: 1.0, started: Date(), stoped: Date(), fileName: "")]
}
